...
<section>
  <center>
   <center><h1><u>Instructors Form</u></h1></center>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $connection->prepare("INSERT INTO instructors(instructor_id, user_id, full_name) VALUES (?, ?, ?)");
        $stmt->bind_param("sss", $instructorid, $userid, $fullname);
    ...
    <table border="5">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $instructor_id = $row['instructor_id']; // Fetch the instructor ID
                echo "<tr>
